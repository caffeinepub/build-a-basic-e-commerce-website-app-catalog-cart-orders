...
export class Backend implements backendInterface {
    ...
    async calculateCartTotals(): Promise<{
        tax: bigint;
        total: bigint;
        subtotal: bigint;
    }> {
        if (this.processError) {
            try {
                const result = await this.actor.calculateCartTotals();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterProductsByPriceCategory(arg0: string): Promise<Array<RichProduct>> {
        if (this.processError) {
            try {
                const result = await this.actor.filterProductsByPriceCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async filterProductsByPriceRange(arg0: bigint, arg1: bigint): Promise<Array<RichProduct>> {
        if (this.processError) {
            try {
    ...
    async getAllProducts(): Promise<Array<RichProduct>> {
        if (this.processError) {
            try {
    ...
    async getProduct(arg0: bigint): Promise<RichProduct | null> {
        if (this.processError) {
            try {
    ...
    async isProductInCatalog(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isProductInCatalog(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async isStoreInitialized(): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.isStoreInitialized();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async placeOrderWithPaymentMethod(arg0: PaymentMethod): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.placeOrderWithPaymentMethod(to_candid_PaymentMethod_n20(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchProducts(arg0: string): Promise<Array<RichProduct>> {
        if (this.processError) {
            try {
...
function from_candid_opt_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_RichProduct]): RichProduct | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_variant_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "creditCard" in value ? PaymentMethod.creditCard : "cashOnDelivery" in value ? PaymentMethod.cashOnDelivery : "crypto" in value ? PaymentMethod.crypto : "klarnaPayLater" in value ? PaymentMethod.klarnaPayLater : "paypal" in value ? PaymentMethod.paypal : value;
}
...
function to_candid_variant_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PaymentMethod): {
    ...
    return value == PaymentMethod.creditCard ? {
        ...
        crypto: null
    } : value == PaymentMethod.klarnaPayLater ? {
        klarnaPayLater: null
